...
# PARAMETER organism: "Genome or transcriptome" TYPE ["FILES genomes/indexes/bowtie .fa"] DEFAULT "SYMLINK_TARGET genomes/indexes/bowtie/default" (Genome or transcriptome that you would like to align your reads against.)
